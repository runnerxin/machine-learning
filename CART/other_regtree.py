...
if __name__ == "__main__":
    ...
    # # 回归树
    # myDat = loadDataSet('input/data1.txt')
    ...
    # myDat = loadDataSet('input/data3.txt')
    # myMat = mat(myDat)
    # myTree = createTree(myMat, ops=(0, 1))
    # print(myTree)
    #
    # # 2. 后剪枝就是：通过测试数据，对预测模型进行合并判断
    # myDatTest = loadDataSet('input/data3test.txt')
    ...
    # # --------
    # # 模型树求解
    # myDat = loadDataSet('input/data4.txt')
    # myMat = mat(myDat)
    # myTree = createTree(myMat, modelLeaf, modelErr)
    # print(myTree)

    # # 回归树 VS 模型树 VS 线性回归
    trainMat = mat(loadDataSet('input/bikeSpeedVsIq_train.txt'))
    testMat = mat(loadDataSet('input/bikeSpeedVsIq_test.txt'))
    # # 回归树
